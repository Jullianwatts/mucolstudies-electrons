...
h_2d = ROOT.TH2F("2d", ";Track p [GeV];Cluster E [GeV]", 100, 0, 50, 100, 0, 50)
r = pyLCIO.IOIMPL.LCFactory.getInstance().createLCReader()

ev_idx = 0
for f in glob.glob("/scratch/jwatts/mucol/v11Container/reco/1kelectron25_reco.slcio"):
...
l = ROOT.TLine(0, 0, 50, 50); l.SetLineColor(ROOT.kRed); l.SetLineStyle(2); l.Draw("SAME"); c.SaveAs("plots2026/electron_E_vs_p_2D.png")
