...
read.Files = ["/scratch/jwatts/mucol/data/pionGun_pT_0_50_sim_1.slcio"]
algList.append(read)
...
MyAIDAProcessor.Parameters = {
    "LCIOOutputFile": [
        "/scratch/jwatts/mucol/data/reco/pionGun_pT_0_50/"
        "pionGun_pT_0_50_reco_3.root"
    ],
    "FileType": ["root"]
}
